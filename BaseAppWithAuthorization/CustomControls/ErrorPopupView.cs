...
using BaseAppWithAuthorization.Helpers;
using BaseAppWithAuthorization.Models;
...
namespace BaseAppWithAuthorization.CustomControls
{
    public partial class ErrorPopupView : ContentView, INotifyPropertyChanged
    {
        ...
        {
            get => (bool)GetValue(ShoErrorMessageProperty);
